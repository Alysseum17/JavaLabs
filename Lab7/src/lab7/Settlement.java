...
public class Settlement implements Comparable<Settlement>, Serializable {
    ...
    public void setArea(double area) {
        if (area >= 0) {
            ...
            throw new IllegalArgumentException("Площа не може бути від'ємною!");
        }
    }
    ...
    public void setFoundedYear(int year) {
        if (year > 0) {
            ...
            throw new IllegalArgumentException("Рік заснування має бути позитивним!");
        }
    }
    ...
    public void addCrossroad(Crossroad c) {
        if (crossroadCount < MAX_CROSSROADS) {
            ...
            throw new IllegalStateException("Досягнуто максимум перехресть!");
        }
    }
    ...
    public void decreasePopulation(int amount) {
        if (amount > 0 && population - amount >= 0) {
            ...
            throw new IllegalArgumentException("Неможливо зменшити населення: некоректне значення!");
        }
    }
